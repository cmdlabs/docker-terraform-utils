...
- Upgraded tf-lint to 0.47.0
- Upgraded tf-lint-aws rule set to 0.25.0

## [11.0.3] - 2023-05-10
### Changed
- Upgraded terraform to 1.3.9
- Upgraded tf-lint to 0.46.1
- Upgraded tf-lint-aws rule set to 0.23.0

## [10.5.0] - 2022-02-04
### Changed
- Upgraded terraform to 1.1.5
- Upgraded tf-lint to 0.34.1
- Upgraded tf-lint-aws rule set to 0.10.1
...
### Added
- Added python libraries: pan-os-python boto3
